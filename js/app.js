//Locations array to define all locations data
var locations = [{
            ...
            if (infoWindow.marker != marker) {
                ...
                this.getStreetView= function(data, status) {
                    ...
                    if (status === google.maps.StreetViewStatus.OK) {
                        ...
                        infoWindow.setContent('<div><h4>' + marker.title + '</h4></div><div id="pano"></div><div><br><strong>Wiki URL: </strong><a target="_blank" href ="' + articleUrl + '">' + articleUrl + '</a><hr></div>');
                        var panoramaOptions = {
...
//Error message when Google map is not loaded correctly
function mapError() {
  alert("Google Map is not loaded correctly for this page");
}